...
- **Automatic Total**: Saare kharchon ka total real-time calculate hota hai
- **Expense List**: Saari added expenses ki list dikhti hai
- **Delete Expense**: Ghalat entry delete kar sakte ho
